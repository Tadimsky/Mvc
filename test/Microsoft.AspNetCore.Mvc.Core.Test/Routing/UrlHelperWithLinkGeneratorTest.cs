...
namespace Microsoft.AspNetCore.Mvc.Routing
{
    public class UrlHelperWithLinkGeneratorTest
    {
        ...
        {
            // Arrange
            var urlHelper = CreateUrlHelper(GetEndpoints(), appRoot);
        ...
        {
            // Arrange
            var helper = CreateUrlHelper(GetEndpoints(), host: "www.mysite.com");
        ...
        //        null,
        //        new Address("default")));
        //    var urlHelper = CreateUrlHelper(GetEndpoints(), appRoot: "/app", host: "myhost", protocol: "https");
